            ...
            <main className={`flex flex-col items-center justify-center gap-[10px] ${styles.main}`}>
                ...
                <div id="hero" className="text-3xl 2xl:text-4xl text-center w-full h-screen pt-[20vh] 2xl:pt-[17vh]">
                        ...
                        <div className="absolute right-0">
                            ...
                            <div className="absolute -top-[95%] -right-[45%]">
                                ...
                                <g filter="url(#filter0_f_9_594)">
                                    ...
                                    <path fillRule="evenodd" clipRule="evenodd" d="M1469 324C1469 246.68 1406.32 184 1329 184H324C246.68 184 184 246.68 184 324V944.873C184 1022.19 246.68 1084.87 324 1084.87H1329C1406.32 1084.87 1469 1022.19 1469 944.873V324ZM1281.29 439.977C1281.29 362.657 1218.61 299.977 1141.29 299.977H513.092C435.772 299.977 373.092 362.657 373.092 439.977V866.383C373.092 943.703 435.772 1006.38 513.092 1006.38H1141.29C1218.61 1006.38 1281.29 943.703 1281.29 866.383V439.977Z"/>
                                    </mask>
                                ...
                                <defs>
                                    <filter id="filter0_f_9_594" x="0" y="0" width="1653" height="1268.87" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                    ...
                    <div className="flex pt-[175px] justify-center items-start gap-[25px] mix-blend-overlay z-50">
                        <button className={`px-[32px] py-[8px] text-2xl border-4 rounded-full border-orange-500 bg-orange-50 shadow-xl cursor-pointer`}>
                            <Link href="/films">
                                You need film help
                            </Link>
