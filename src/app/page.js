  ...
  return (
    <>
      <main className={`flex flex-col items-center justify-center gap-[10px] ${styles.main}`}>
        <div id="hero" className="text-3xl 2xl:text-4xl text-center w-full h-screen pt-[10vh] 2xl:pt-[8vh]">
          ...
          <div className="flex pt-[150px] justify-center items-start gap-[25px] mix-blend-overlay z-50">
            <button className={`px-[32px] py-[8px] text-2xl border-4 rounded-full 
            border-orange-500 bg-orange-50 shadow-xl cursor-pointer`}>
